(compile-file (merge-pathnames "ltk/ltk" *load-truename*))
(load (merge-pathnames "ltk/ltk" *load-truename*))
(compile-file (merge-pathnames "cl-jpeg-master/package" *load-truename*))
(load (merge-pathnames "cl-jpeg-master/package" *load-truename*))
(compile-file (merge-pathnames "cl-jpeg-master/jpeg" *load-truename*))
(load (merge-pathnames "cl-jpeg-master/jpeg" *load-truename*))
(compile-file (merge-pathnames "pixels" *load-truename*))
(load (merge-pathnames "pixels" *load-truename*))
...
(defun load-file (path BW R G B)
  (let (arr (JPEG:Decode-Image path))
    ...
    (JPEG:Encode-Image filename arr 3 (first dim) (second dim))))
